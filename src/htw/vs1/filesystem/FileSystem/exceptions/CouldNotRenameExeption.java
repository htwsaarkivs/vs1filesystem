 ...
 */
public class CouldNotRenameExeption extends FSObjectException {
    /**
     ...
     */
    public CouldNotRenameExeption(FSObject object, String msg, Throwable ex) {
        super(object, msg, ex);
    }
     ...
     */
    public CouldNotRenameExeption(String msg, Throwable ex) {
        super(msg, ex);
    }
     ...
     * @param msg Error message of the Expetion
     */
    public CouldNotRenameExeption(String msg) {
        super(msg);
    }
}
