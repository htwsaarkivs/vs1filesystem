 ...
 */
public class JFrameIconExtern extends JFrame {
    ...
    private void buildPane() {
        ...
        button1.addActionListener(new JFrameIconExternAListener());
        button2.setActionCommand("button2");
        button2.addActionListener(new JFrameIconExternAListener());
    }
}
